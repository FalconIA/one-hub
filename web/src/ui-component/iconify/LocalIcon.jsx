  ...
  React.useEffect(() => {
    async function loadIcon() {
      try {
        ...
        // 添加完整的 SVG 标签
        const fullSvg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${width}" height="${height || width}" viewBox="0 0 ${iconData.width || 24} ${iconData.height || 24}">${svgData.body}</svg>`;
        setSvg(fullSvg);
      } catch (error) {
